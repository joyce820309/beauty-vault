...
import { Home, Package, Search, BarChart2, Droplets, Sparkles, User, CalendarClock, ShoppingBag } from 'lucide-react'
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-[var(--color-bg-card)] border-r border-[var(--color-border)] flex flex-col">
      <div className="px-6 py-5 border-b border-[var(--color-border)]">
        <h1 className="text-lg font-semibold text-[var(--color-primary)]">BeautyVault</h1>
      </div>
